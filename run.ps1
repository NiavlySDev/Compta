...
$exePath = "BlackWoodsCompta\src\BlackWoodsCompta.WPF\bin\Debug\net8.0-windows\BlackWoodsCompta.WPF.exe"
if (-not (Test-Path $exePath)) {
    ...
    dotnet build BlackWoodsCompta/src/BlackWoodsCompta.sln --configuration Debug
...
dotnet run --project BlackWoodsCompta/src/BlackWoodsCompta.WPF/BlackWoodsCompta.WPF.csproj --no-build
